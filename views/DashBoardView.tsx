      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.servicesContainer}>
            <TouchableOpacity
              onPress={this.navigateToCarRequest}
              style={styles.service}>
              <Image
                style={styles.iconStyle}
                source={require('../assets/icons/1-01.png')}
              />
              <Text style={{color: 'white', fontSize: 12}}>Car</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.service}
            ...
            <TouchableOpacity
              onPress={this.navigateToTowRequest}
              style={styles.service}>
              <Image
                style={styles.iconStyle}
                source={require('../assets/icons/3-01.png')}
              />
              <Text style={{color: 'white', fontSize: 12}}>Towing</Text>
            </TouchableOpacity>
            ...
            <View style={styles.service}>
              ...
              />
              <Text style={{color: 'white', fontSize: 12}}>Accessories</Text>
            </View>
            <View style={styles.service}>
              <Image
                style={styles.iconStyle}
              ...
              />
              <Text style={{color: 'white', fontSize: 12}}>Ask Membership</Text>
            </View>
          </View>
        </ScrollView>
