...
class UserScreen extends React.Component<UserScreenProps, UserScreenState> {
  ...
  getProfileDetails = async () => {
    ...
    getUserProfile(userId).then((response: any) => {
      const email =
        response.data['User Email'] === null ? '' : response.data['User Email'];
      const username =
        response.data['User Name'] === null ? '' : response.data['User Name'];
        ...
        <ScrollView nestedScrollEnabled={true} style={styles.scrollContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            <View
              ...
              {this.state.userVehicleBike.length === 0 ? (
                <Text
                  style={{
                    color: 'white',
                    fontSize: 20,
                  ...
                  You have no vehicles in your profile
                </Text>
              ) : null}
            </View>
            <TouchableOpacity
